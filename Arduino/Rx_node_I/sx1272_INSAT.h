...
#ifndef sx1272_INSAT_h
#define sx1272_INSAT_h
...
//frf = 32e6*FRF/2^19
const uint32_t CH_868v1 = 0xD90666; // central freq = 868.10MHz
const uint32_t CH_868v3 = 0xD91333; // central freq = 868.30MHz
const uint32_t CH_868v5 = 0xD92000; // central freq = 868.50MHz
//! Other channels:
...
const uint8_t POW_m1 = 0x0;
const uint8_t POW_0 = 0x1;
const uint8_t POW_1 = 0x2;
const uint8_t POW_2 = 0x3;
const uint8_t POW_3 = 0x4;
const uint8_t POW_4 = 0x5;
const uint8_t POW_5 = 0x6;
const uint8_t POW_6 = 0x7;
const uint8_t POW_7 = 0x8;
const uint8_t POW_8 = 0x9;
const uint8_t POW_9 = 0xA;
const uint8_t POW_10 = 0xB;
const uint8_t POW_11 = 0xC;
const uint8_t POW_12 = 0xD;
const uint8_t POW_13 = 0xE;
const uint8_t POW_14 = 0xF;
...
const uint16_t FDA5kHz = 0x52;
const uint16_t FDA40kHz = 0x28F;
const uint16_t FDA125kHz = 0x7FF;
const uint16_t BR1200bauds = 0x682B;
const uint16_t BR4800bauds = 0x1A0B;
const uint16_t BR38p4kbauds = 0x30D;
const uint16_t BR62p5kbauds = 0x200;

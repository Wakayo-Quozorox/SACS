...
uint8_t sx1272_INSAT::ON(int type_mod)
{
	...
	// for the board Arduino MEGA 2560, set to 2MHz
...
*/
byte sx1272_INSAT::readRegister(byte address)
{
    byte value = 0x00;
...
*/
void sx1272_INSAT::writeRegister(byte address, byte data)
{
...
uint8_t sx1272_INSAT::setFSK()
{
  ...
  // Config REG_SYNC_CONFIG
	...
	config1 = config1 & B00111111; //Auto-restart off, sync word detection on, sync size = 4 words
...
*/
boolean	sx1272_INSAT::isSF(uint8_t spr)
{
  #if (SX1272_debug_mode > 1)
	  Serial.println();
...
*/
boolean	sx1272_INSAT::isBW(uint16_t band)
{
  #if (SX1272_debug_mode > 1)
	  Serial.println();
...
*/
boolean	sx1272_INSAT::isCR(uint8_t cod)
{
  #if (SX1272_debug_mode > 1)
	  Serial.println();
...
*/
boolean	sx1272_INSAT::isChannel(uint32_t ch)
{
  #if (SX1272_debug_mode > 1)
	  Serial.println();
...
/*
 ...
 Returns: Integer that determines if there has been any error
   ...
   state = 0  --> The command has been executed with no errors
*/
uint8_t sx1272_INSAT::getPreambleLength()
{
	int8_t state = 2;
	uint8_t p_length;
...
*/
uint8_t sx1272_INSAT::setPreambleLength(uint16_t l)
{
	byte st0;
	uint8_t p_length;
	int8_t state = 2;
...
/*
 ...
 Returns: Integer that determines if there has been any error
   ...
   state = 0  --> The command has been executed with no errors
*/
uint8_t sx1272_INSAT::getPayloadLength()
{
	uint8_t state = 2;
...
/*
 ...
 Returns: Integer that determines if there has been any error
   ...
   state = -1 --> Forbidden command for this protocol
*/
int8_t sx1272_INSAT::setPacketLength()
{
	uint16_t length;
...
*/
int8_t sx1272_INSAT::setPacketLength(uint8_t l)
{
	byte st0;
	byte value = 0x00;
	int8_t state = 2;
...
/*
 ...
 Returns: Integer that determines if there has been any error
   ...
   state = 0  --> The command has been executed with no errors
*/
uint8_t sx1272_INSAT::getNodeAddress()
{
	byte st0 = 0;
	uint8_t state = 2;
...
*/
int8_t sx1272_INSAT::setNodeAddress(uint8_t addr)
{
	byte st0;
	byte value;
	uint8_t state = 2;
...
/*
 ...
 Returns: Integer that determines if there has been any error
   ...
   state = -1 -->
*/
uint8_t sx1272_INSAT::setRetries(uint8_t ret)
{
	uint8_t state = 2;
...
*/
uint8_t sx1272_INSAT::getMaxCurrent()
{
	int8_t state = 2;
	byte value;
...
*/
int8_t sx1272_INSAT::setMaxCurrent(uint8_t rate)
{
	int8_t state = 2;
	byte st0;
...
/*
 ...
 Returns: Integer that determines if there has been any error
   ...
   state = 0  --> The command has been executed with no errors
*/
uint8_t sx1272_INSAT::truncPayload(uint16_t length16)
{
	uint8_t state = 2;
...
/*
 ...
 Returns: Integer that determines if there has been any error
   ...
   state = 0  --> The command has been executed with no errors
*/
uint8_t sx1272_INSAT::receivePacketMAXTimeout()
{
...
/*
 ...
 Returns: Integer that determines if there has been any error
   ...
   state = 0  --> The command has been executed with no errors
*/
uint8_t sx1272_INSAT::receivePacketTimeout()
{
	setTimeout();
...
/*
 ...
 Returns: Integer that determines if there has been any error
   ...
   state = 0  --> The command has been executed with no errors
*/
uint8_t sx1272_INSAT::receivePacketTimeout(uint32_t wait)
{
	uint8_t state = 2;
	uint8_t state_f = 2;
...
/*
 ...
 Returns: Integer that determines if there has been any error
   ...
   state = 0  --> The command has been executed with no errors
*/
uint8_t sx1272_INSAT::receivePacketMAXTimeoutACK()
{
...
/*
 ...
 Returns: Integer that determines if there has been any error
   ...
   state = 0  --> The command has been executed with no errors
*/
uint8_t sx1272_INSAT::receivePacketTimeoutACK()
{
	setTimeout();
...
/*
 ...
 Returns: Integer that determines if there has been any error
   ...
   state = 0  --> The command has been executed with no errors
*/
uint8_t sx1272_INSAT::receivePacketTimeoutACK(uint32_t wait)
{
	uint8_t state = 2;
	uint8_t state_f = 2;
...
/*
 ...
 Returns: Integer that determines if there has been any error
   ...
   state = 0  --> The command has been executed with no errors
*/
uint8_t sx1272_INSAT::receiveAll(uint32_t wait)
{
	uint8_t state = 2;
	byte config1;
...
*/
boolean	sx1272_INSAT::availableData()
{
...
*/
boolean	sx1272_INSAT::availableData(uint32_t wait)
{
	byte value;
	byte header = 0;
	boolean forme = false;
	...
	{ 
			...
			Serial.println(_destination,DEC);
			Serial.print(F("Node address = "));
			Serial.println(_nodeAddress,DEC);
			Serial.print(F("Broadcast address = "));
			Serial.println(BROADCAST_0,DEC);
		#endif
...
/*
 ...
 Returns:  Integer that determines if there has been any error
   ...
   state = 0  --> The command has been executed with no errors
*/
uint8_t sx1272_INSAT::getPacketMAXTimeout()
{
...
/*
 ...
 Parameters:
   wait: time to wait while there is no a valid header received.
*/
int8_t sx1272_INSAT::getPacket(uint32_t wait)
{
	uint8_t state = 2;
	uint8_t state_f = 2;
	byte value = 0x00;
...
*/
int8_t sx1272_INSAT::setDestination(uint8_t dest)
{
	int8_t state = 2;
...
/*
 ...
 Returns: Integer that determines if there has been any error
   ...
   state = 0  --> The command has been executed with no errors
*/
uint8_t sx1272_INSAT::setTimeout()
{
	uint8_t state = 2;
	uint16_t delay;
...
/*
 ...
 Returns:  Integer that determines if there has been any error
   ...
   state = 0  --> The command has been executed with no errors
*/
uint8_t sx1272_INSAT::setPayload(char *payload)
{
	uint8_t state = 2;
	uint8_t state_f = 2;
	uint16_t length16;
...
/*
 ...
 Returns:  Integer that determines if there has been any error
   ...
   state = 0  --> The command has been executed with no errors
*/
uint8_t sx1272_INSAT::setPayload(uint8_t *payload)
{
	uint8_t state = 2;
...
/*
 ...
 Returns:  Integer that determines if there has been any error
   ...
   state = 0  --> The command has been executed with no errors
*/
uint8_t sx1272_INSAT::setPacket(uint8_t dest, char *payload)
{
	int8_t state = 2;
	byte st0;
...
/*
 ...
 Returns:  Integer that determines if there has been any error
   ...
   state = 0  --> The command has been executed with no errors
*/
uint8_t sx1272_INSAT::setPacket(uint8_t dest, uint8_t *payload)
{
	int8_t state = 2;
	byte st0;
...
/*
 ...
 Returns: Integer that determines if there has been any error
   ...
   state = 0  --> The command has been executed with no errors
*/
uint8_t sx1272_INSAT::sendWithMAXTimeout()
{
...
/*
 ...
 Returns: Integer that determines if there has been any error
   ...
   state = 0  --> The command has been executed with no errors
*/
uint8_t sx1272_INSAT::sendWithTimeout()
{
	setTimeout();
...
/*
 ...
 Returns: Integer that determines if there has been any error
   ...
   state = 0  --> The command has been executed with no errors
*/
uint8_t sx1272_INSAT::sendWithTimeout(uint32_t wait)
{
	uint8_t state = 2;
	byte value = 0x00;
	unsigned long previous;
...
/*
 ...
 Returns: Integer that determines if there has been any error
   ...
   state = 0  --> The command has been executed with no errors
*/
uint8_t sx1272_INSAT::sendPacketMAXTimeout(uint8_t dest, char *payload)
{
...
/*
 ...
 Returns: Integer that determines if there has been any error
   ...
   state = 0  --> The command has been executed with no errors
*/
uint8_t sx1272_INSAT::sendPacketTimeout(uint8_t dest, char *payload)
{
	uint8_t state = 2;
		...
		Serial.println(F("Passe dans sendPacketTimeout(uint8_t dest, char *payload)"));
	#endif
										...
										uint16_t length16)
{
	...
	uint8_t state_f = 2;
		...
		Serial.println();
		Serial.println(F("Starting 'sendPacketTimeout'"));
		Serial.println(F("Passe dans sendPacketTimeout(uint8_t dest, uint8_t *payload, uint16_t length16)"));
	#endif
...
/*
 ...
 Returns: Integer that determines if there has been any error
   ...
   state = 0  --> The command has been executed with no errors
*/
uint8_t sx1272_INSAT::sendPacketTimeout(uint8_t dest, char *payload, uint32_t wait)
{
	uint8_t state = 2;
		...
		Serial.println();
		Serial.println(F("Starting 'sendPacketTimeout'"));
		Serial.println(F("Passe dans sendPacketTimeout(uint8_t dest, char *payload, uint32_t wait)"));
	#endif
										...
										uint32_t wait)
{
	...
	uint8_t state_f = 2;
		...
		Serial.println();
		Serial.println(F("Starting 'sendPacketTimeout'"));
		Serial.println(F("Passe dans sendPacketTimeout(uint8_t dest, uint8_t *payload, uint16_t length16, uint32_t wait)"));
	#endif
...
/*
 ...
 Returns: Integer that determines if there has been any error
   ...
   state = 0  --> The command has been executed with no errors
*/
uint8_t sx1272_INSAT::sendPacketMAXTimeoutACK(uint8_t dest, char *payload)
{
...
/*
 ...
 Returns: Integer that determines if there has been any error
   ...
   state = 0  --> The command has been executed with no errors
*/
uint8_t sx1272_INSAT::sendPacketTimeoutACK(uint8_t dest, char *payload)
{
	uint8_t state = 2;
	uint8_t state_f = 2;
...
/*
 ...
 Parameters:
   wait: time to wait while there is no a valid header received.
*/
uint8_t sx1272_INSAT::getACK(uint32_t wait)
{
	uint8_t state = 2;
	byte value = 0x00;
	unsigned long previous;
...
/*
 ...
 Returns: Integer that determines if there has been any error
   ...
   state = 0  --> The command has been executed with no errors
*/
uint8_t sx1272_INSAT::sendPacketTimeoutACKRetries(uint8_t dest, char *payload)
{
	uint8_t state = 2;
